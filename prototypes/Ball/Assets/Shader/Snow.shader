	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 frag(Varyings IN) : SV_Target
			{
				...
				half shadowAmount0 = MainLightRealtimeShadow(IN.shadowCoords);
				half shadowAmount1 = MainLightRealtimeShadow(IN.shadowCoords + float4(0.0002,0,0,0));
				half shadowAmount2 = MainLightRealtimeShadow(IN.shadowCoords - float4(0.0002,0,0,0));
				half shadowAmount3 = MainLightRealtimeShadow(IN.shadowCoords - float4(0,0,0.0002,0));
