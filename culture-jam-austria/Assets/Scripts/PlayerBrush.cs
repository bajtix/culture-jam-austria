...
public class PlayerBrush : PlayerComponent {
    ...
    private void FixedUpdate() {
        ...
        void PlaceFootstep(Vector3 pos, Vector2 sc) {
            ...
            m_surface.AddTextureMark(m_print, hit.textureCoord, transform.rotation.eulerAngles.y, sc, m_strength);
        }

        var stepPosition = transform.position + transform.right * (m_left ? 1 : -1) * m_footstepOffset;
        PlaceFootstep(stepPosition, new Vector2(m_left ? m_scale : -m_scale, m_scale));
